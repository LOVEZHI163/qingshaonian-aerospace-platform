...
- 011 在建唯一索引前先确定性去重 active；012 覆盖 011 已执行库的 `pending/invited` 未绑定邀请。
- active 冲突只向关系本人返回 relation；负责人不可获知他人当前组织信息。有效操作者的无效状态迁移也返回最新安全 relation。
- 管理员 memberCount 仅统计有效普通 active member；报名摘要增加赛事/项目名称与未知关联回退。
