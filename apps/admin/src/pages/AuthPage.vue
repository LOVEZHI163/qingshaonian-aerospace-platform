...
<template>
  <div class="auth-shell">
    <header class="auth-header">
      ...
      <div class="auth-event-context"><span>当前赛事</span><p>{{ props.eventName || "请登录后在赛事中心选择赛事" }}</p></div>
    </header>
