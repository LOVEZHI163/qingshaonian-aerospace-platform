...
ALTER TABLE registrations DROP CONSTRAINT IF EXISTS registrations_created_by_user_id_fk;
...
ALTER TABLE registrations DROP CONSTRAINT IF EXISTS registrations_organization_id_fk;
...
ALTER TABLE registrations DROP CONSTRAINT IF EXISTS registrations_owner_check;
